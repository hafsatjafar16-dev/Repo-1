...
- `regulatory/eu-1223-2009-overview.md` — EU Cosmetics Regulation working
  reference (RP duties, PIF/CPSR, notification, labelling, claims, restricted
  substance Annexes, other EMEA markets).
- `regulatory/market-entry-checklist.md` — per-client/per-SKU checklist for
  taking a product from formula to legally on the EU market.
